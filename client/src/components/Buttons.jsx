...
const Buttons = ({label, outline, small, icon, onClick}) => {
  return (
    <button onClick={onClick} disabled className={`relative disabled:opacity-70 disabled:cursor-not-allowed rounded-lg hover:opacity-80 transition w-full
